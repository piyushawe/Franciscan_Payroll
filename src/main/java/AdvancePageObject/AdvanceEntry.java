...
public class AdvanceEntry {
  WebDriver dr;
  String pg="AdvanceEntry";
  Utility u= new Utility();
					  
  public AdvanceEntry(WebDriver d)
  {
	  this.dr=d;
	  PageFactory.initElements(d, this);
  }
  public void openAdvanceEntry()
  {
	  WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Advance.png']"));
	  Actions builder= new Actions(dr);
	  builder.moveToElement(menu).build().perform();
	  dr.findElement(By.linkText("Advance entry")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Payroll/PayAdvanceEntry.aspx']")));
