...
public class DefineSalaryHead {
	WebDriver dr;
    String pg="DefineSalaryHead";
	Utility u= new Utility();
				  
	@FindBy(id="ContentPlaceHolder1_txtSlNo_TextBox")WebElement serialno;
	  
	public DefineSalaryHead(WebDriver d)
	{
	   this.dr=d;
	   PageFactory.initElements(d, this);
	}
	public void openDefineSalaryHead()
	{
	  WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Payroll-Master.png']"));
	  Actions builder= new Actions(dr);
	  builder.moveToElement(menu).build().perform();
	  dr.findElement(By.linkText("Define Salary Head")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Payroll/DefineSalaryHeads.aspx']")));
