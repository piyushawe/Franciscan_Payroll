...
public class DefineITHeadGroups {
  WebDriver dr;
  String pg="DefineITHeadGroups";
  Utility u= new Utility();
			  
  @FindBy(id="ContentPlaceHolder1_txtSlno_TextBox")WebElement serialno;
  
  public DefineITHeadGroups(WebDriver d)
  {
	  this.dr=d;
	  PageFactory.initElements(d, this);
  }
  public void openDefineITHeadGroups()
  {
	  WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Payroll-Master.png']"));
	  Actions builder= new Actions(dr);
	  builder.moveToElement(menu).build().perform();
	  dr.findElement(By.linkText("Define IT Head Groups")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Payroll/DefineITHeadGroups.aspx']")));
