...
public class MonthWiseSalaryReport {
	WebDriver dr;
	String r= "MonthWiseSalaryReport";
	Utility u= new Utility();
	  ...
	  public MonthWiseSalaryReport(WebDriver d)
	  {
		 this.dr=d;
		 PageFactory.initElements(d, this);
	  }
	  public void openMonthWiseSalaryReport()
	  {
		 WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Salary-Reports.png']"));
		 Actions builder= new Actions(dr);
		 builder.moveToElement(menu).build().perform();
		 dr.findElement(By.linkText("Month Wise Salary Report")).click();
		 dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Payroll/RptSalaryReport.aspx']")));
	  }
