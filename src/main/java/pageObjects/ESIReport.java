...
public class ESIReport {
  ...
  @FindBy(id="ContentPlaceHolder1_ddlFromat")WebElement format;
  @FindBy(id="ContentPlaceHolder1_btnShow")WebElement show;
  
  public ESIReport(WebDriver d)
  {
	  this.dr=d; 
	  PageFactory.initElements(d, this);
  }
  public void openESIReport()
  {
	  WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Reports.png']"));
	  Actions builder= new Actions(dr);
	  builder.moveToElement(menu).build().perform();
	  dr.findElement(By.linkText("ESI Report")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Payroll/ESIReport.aspx']")));
  }
