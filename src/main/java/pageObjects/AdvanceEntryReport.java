...
public class AdvanceEntryReport {
 WebDriver dr;
 String r="AdvanceEntryReport";
 ...
 public AdvanceEntryReport(WebDriver d)
 {
	 this.dr=d;
	 PageFactory.initElements(d, this);
 }
 public void openAdvanceEntryReport()
 {
	 WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Salary-Reports.png']"));
	 Actions builder= new Actions(dr);
	 builder.moveToElement(menu).build().perform();
	 dr.findElement(By.linkText("Advance Entry Report")).click();
	 dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Payroll/AdvanceEntryReport.aspx']")));
 }
