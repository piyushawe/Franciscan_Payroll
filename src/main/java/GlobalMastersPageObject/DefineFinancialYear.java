...
public class DefineFinancialYear {
  ...
  @FindBy(id="ContentPlaceHolder1_txtcalstartdat_ddlyear")WebElement startyear;
  @FindBy(id="ContentPlaceHolder1_txtcalstartdat_ddlmonth")WebElement startmonth;
  @FindBy(id="ContentPlaceHolder1_txtcalstartdat_ddlday")WebElement startday;
  @FindBy(id="ContentPlaceHolder1_txtcalenddat_ddlyear")WebElement endyear;
  @FindBy(id="ContentPlaceHolder1_txtcalenddat_ddlmonth")WebElement endmonth;
  @FindBy(id="ContentPlaceHolder1_txtcalenddat_ddlday")WebElement endday;
